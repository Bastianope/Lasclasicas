...
import EliminarAnuncioButton from "@/components/EliminarAnuncioButton";
              ...
              {misAnuncios?.map((anuncio: any) => {
                ...
                return (
                  <div key={anuncio.id}
                    ...
                    <Link href={`/anuncios/${anuncio.id}`} className="block">
                    ...
                    <div className="flex items-center gap-2 px-4 pb-4">
                      ...
                      <EliminarAnuncioButton anuncioId={anuncio.id} />
                    </div>
                  </div>
                );
              })}
